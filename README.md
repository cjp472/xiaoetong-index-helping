...
1. 图片需要进一步压缩，有多张图片过于巨大，实际上不需要这么大，另外部分图片裁切不准确，有些不应该出现在用户界面的应该裁剪。举例：
...
5. 视频格式中， <source> 中虽然指定了ogg,webm,mp4 格式，但实际上 src 的地址全是 mp4，并未做区分。举例：
...
2. 流量账户界面中，点击资费说明时，弹出的提示，应该对文字进行区分，以便用户阅读，重点部分，用不同的颜色来处理，以便用户快速抓住重点，另外，对于这种弹出框，点击遮罩层后，应该要能够隐藏自身
